...
var _refs = require("./tools/refs");
var _refsDefault = parcelHelpers.interopDefault(_refs);
var _eventHandlers = require("./tools/eventHandlers");
var _scrollHandlers = require("./tools/scrollHandlers");
var _lodash = require("lodash");
var _lodashDefault = parcelHelpers.interopDefault(_lodash);
const refs = (0, _refsDefault.default)();
refs.loadMoreBtn.addEventListener("click", (0, _eventHandlers.onLoadMore));
refs.form.addEventListener("submit", (0, _eventHandlers.onSubmit));
document.addEventListener("scroll", (0, _lodashDefault.default).throttle((0, _scrollHandlers.scroll), 700));

},{"./tools/refs":"i7qla","./tools/eventHandlers":"4PK9X","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./tools/scrollHandlers":"73qD2","lodash":"3qBDj"}],"i7qla":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"4PK9X":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "onSubmit", ()=>onSubmit);
parcelHelpers.export(exports, "onLoadMore", ()=>onLoadMore);
...
const ref = (0, _refsDefault.default)();
let count = 1;
let previousSearch = "";
async function onSubmit(e) {
    ...
    if (searchQuery.value.toLowerCase() === previousSearch.toLowerCase()) return;
    try {
        const images = await (0, _fetchImagesDefault.default)(searchQuery.value, count);
        if (images.length === 0) {
        ...
        if (!ref.loadMoreBtn.classList.contains("active")) ref.loadMoreBtn.classList.add("active");
        (0, _notiflixDefault.default).Notify.success("Hooray! We found totalHits images.");
        previousSearch = searchQuery.value;
        ref.gallery.innerHTML = (0, _renderDefault.default)(images);
        (0, _slider.slider).refresh();
        count = 1;
    } catch (error) {
        console.log(error);
    }
...
async function onLoadMore(e) {
    ...
    count++;
    try {
        const images = await (0, _fetchImagesDefault.default)(previousSearch, count);
        if (images.length < 40) {
            (0, _notiflixDefault.default).Notify.info("We're sorry, but you've reached the end of search results.");
            ref.loadMoreBtn.classList.remove("active");
        }
        ref.gallery.insertAdjacentHTML("beforeend", (0, _renderDefault.default)(images));
        (0, _slider.slider).refresh();
    } catch (error) {
        (0, _notiflixDefault.default).Notify.info("We're sorry, but you've reached the end of search results.");
        ref.loadMoreBtn.classList.remove("active");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./fetchImages":"dMupw","./refs":"i7qla","./render":"4e3nI","notiflix":"5WWYd","./slider":"1tYE8"}],"dMupw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const url = "https://pixabay.com/api/";
exports.default = async (name, page)=>{
    const params = {
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4e3nI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _cardTemplate = require("./cardTemplate");
var _cardTemplateDefault = parcelHelpers.interopDefault(_cardTemplate);
exports.default = (array)=>{
    return array.map((0, _cardTemplateDefault.default)).join("");
};

},{"./cardTemplate":"7q1ze","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7q1ze":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = ({ webformatURL , largeImageURL , tags , likes , views , comments , downloads  })=>{
    return `
...
},{}],"1tYE8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const slider = new (0, _simplelightboxDefault.default)(".gallery a");

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","simplelightbox":"9ydBq"}],"9ydBq":[function(require,module,exports) {
/*!
...
},{}],"kaxSc":[function() {},{}],"73qD2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const ref = (0, _refsDefault.default)();
function scroll(e) {
    if (window.scrollY > previous && ref.upBtn.classList.contains("upoff")) ref.upBtn.classList.remove("upoff");
    ...
    if (window.scrollY < 1800 && !ref.upBtn.classList.contains("upoff")) ref.upBtn.classList.add("upoff");
    previous = window.scrollY;
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./refs":"i7qla"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
...
},{}]},["ShInH","8lqZg"], "8lqZg", "parcelRequiree6b9")
